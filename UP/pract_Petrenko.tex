...
На данном этапе система работает нестабильно, ввиду чего автономную миссию выполнять небезопасно -- возможны внештатные ситуации. Для улучшения работы системы необходима дополнительная работа.
